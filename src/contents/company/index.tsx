export const companies = [
  ...
  //   id: 'company2',
  //   contents: [
  //     {id: 'company2_name', title: '会社名', content: '株式会社LCM'},
  //     {id: 'company2_address', title: '所在地', content: '〒594-0032 大阪府和泉市池田下町173番地30'},
  //     {id: 'company2_CEO', title: '代表',  content: '代表取締役 森 厚雄'},
  //     {id: 'company2_date', title: '設立日', content: '2014年12月1日'},
  ...
  // },
  {
    ...
    contents: [
      ...
      {id: 'company1_CEO', title: '代表',  content: '代表取締役 石川清和'},
