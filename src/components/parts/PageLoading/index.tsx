    ...
    <>
      {show && !visited && (
        <div className="fixed top-0 left-0 z-50 w-full h-full">
          ...
          <div className={`${styles.text} absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-40 aspect-square ${textAnimClass}`} style={{fontFamily: 'Cookie'}}><img className='rounded-full' src='/images/logo.png' /></div>
